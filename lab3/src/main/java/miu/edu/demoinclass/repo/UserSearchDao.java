...
public class UserSearchDao {
    ...
    public User findAllByCriteria(UserCriteriaRequest userCriteriaRequest){
        ...
        if (userCriteriaRequest.getCommentId() != 0) {
            Predicate commentIdPredicate = criteriaBuilder.equal(postJoin.join("comments").get("id"), userCriteriaRequest.getCommentId());
